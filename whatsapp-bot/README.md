...
4. Desplegar y revisar los logs: la primera vez se imprime un QR en el log — escanéalo desde el WhatsApp que administrará los grupos (Configuración > Dispositivos vinculados).
