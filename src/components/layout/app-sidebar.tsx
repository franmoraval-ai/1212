...
const navItems = [
  ...
  { icon: Building2, label: "Puestos", href: "/operations", minLevel: 3, enabled: moduleFlags.operations, requiredPermission: "operation_catalog_manage" as CustomPermission },
